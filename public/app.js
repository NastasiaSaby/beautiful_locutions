...
require.register("client/application", function(exports, require, module) {
'use strict';

//Comme on utilise brunch, on peut lui dire de tout required ici et d'aggréger dans un fichier commun
//Require de brunch
require('./lib/tags');
...
require.register("client/lib/notifications", function(exports, require, module) {
'use strict';
...
;require.register("client/lib/pagination", function(exports, require, module) {
'use strict';
...
;require.register("client/lib/tags", function(exports, require, module) {
'use strict';
...
;require.register("common/helpers", function(exports, require, module) {
...
require.register("common/views/entry", function(exports, require, module) {
var __templateData = function template(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
var locals_ = (locals || {}),entry = locals_.entry,injected = locals_.injected,formatDate = locals_.formatDate;
buf.push("<tr" + (jade.attr("id", entry.id, true, false)) + (jade.cls([injected ? 'injected' : null], [true])) + "><td><div class=\"lead\"><a" + (jade.attr("href", "/entries/" + (entry.id) + "", true, false)) + ">" + (jade.escape(null == (jade_interp = entry.title || entry.url) ? "" : jade_interp)) + "<small class=\"text-muted\"> Par <i>" + (jade.escape((jade_interp = entry.firstname) == null ? '' : jade_interp)) + " " + (jade.escape((jade_interp = entry.name) == null ? '' : jade_interp)) + "</i> " + (jade.escape((jade_interp = formatDate(entry)) == null ? '' : jade_interp)) + "</small></a></div><p><i>" + (jade.escape(null == (jade_interp = entry.expression) ? "" : jade_interp)) + "</i></p><p>Balancé par " + (jade.escape((jade_interp = (entry.poster || {}).name) == null ? '' : jade_interp)) + "</p><p>");
// iterate (entry.tags || [])
;(function(){
  var $$obj = (entry.tags || []);
...
buf.push("&#32;<span class=\"label label-info\">" + (jade.escape(null == (jade_interp = tag) ? "" : jade_interp)) + "</span>");
    }
...
buf.push("</p><p class=\"text-muted\">" + (jade.escape(null == (jade_interp = entry.excerpt) ? "" : jade_interp)) + "</p>");
if ( entry.score !== 0)
{
buf.push("<div class=\"score\">Score : " + (jade.escape((jade_interp = entry.score) == null ? '' : jade_interp)) + "</div>");
}
buf.push("</td></tr>");;return buf.join("");
};
if (typeof define === 'function' && define.amd) {
  define([], function() {
